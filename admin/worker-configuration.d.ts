/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file .env.example` (hash: e531a69b7d95b4febff4cff6ae6dc29a)
...
interface __BaseEnv_Env {
	...
	ANALYTICS_DB_DATABASE_ID: string;
	...
	ANALYTICS_SUMMARY_WORKFLOW: Workflow<
		Parameters<
			import('./.svelte-kit/cloudflare/_worker').AnalyticsSummaryWorkflow['run']
		>[0]['payload']
	>;
}
