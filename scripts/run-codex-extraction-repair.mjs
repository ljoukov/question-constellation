...
8. Use bash pdf-tools.sh for PDF observation commands such as pdf-info, pdftotext-pages, render-pages, crop, and line-count. helper.mjs is the deterministic validator/normalizer; do not call helper.mjs pdf-info or helper.mjs pdftotext-pages.
