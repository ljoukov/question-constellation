---
{
  ...
  'sources':
    [
      {
        'label': 'Rohrer and Taylor, interleaved practice',
        'url': 'https://files.eric.ed.gov/fulltext/ED557355.pdf'
      },
      {
        'label': 'Retrieval Practice guide to interleaving',
        'url': 'https://www.retrievalpractice.org/strategies/2017/interleaving'
      },
      {
        'label': 'Rohrer, Interleaving Helps Students Distinguish among Similar Concepts',
        'url': 'https://files.eric.ed.gov/fulltext/ED536926.pdf'
      }
    ],
  'relatedSlugs':
    [
  ...
  'faqs':
    [
      {
        'question': 'Is interleaving random topic mixing?',
...
## Random practice is not the goal
