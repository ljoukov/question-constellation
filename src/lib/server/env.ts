...
function normalizeServiceAccountJson(value: string): z.infer<typeof serviceAccountSchema> {
...
export function getRuntimeEnv(platformEnv?: unknown): RuntimeEnv {
	...
	const serviceAccount = normalizeServiceAccountJson(raw.GOOGLE_SERVICE_ACCOUNT_JSON);
